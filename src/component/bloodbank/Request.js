    ...
    return(
      <div className="request">
        ...
        <form>
          ...
          <input type="text" placeholder="Middle Name" name='middlename' onChange={handleChange} value={form.middlename} />
          ...
          <input type="text" placeholder="Blood Group" name='bloodgroup' onChange={handleChange} value={form.bloodgroup} />
